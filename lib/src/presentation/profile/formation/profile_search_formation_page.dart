...
@RoutePage()
class ProfileSearchFormationPage extends StatelessWidget {
  static const String routeName = '/profile-search-formation';
  const ProfileSearchFormationPage({super.key});
  ...
  Widget build(BuildContext context) {
    return const MyScaffold(
      ...
      body: _FormationSelectBody(),
    );
  }
}

class _FormationSelectBody extends StatefulWidget {
  const _FormationSelectBody();

  @override
  State<_FormationSelectBody> createState() => _FormationSelectBodyState();
}

class _FormationSelectBodyState extends State<_FormationSelectBody> {
