...
@RoutePage()
class ProfileSearchEntretienPage extends StatelessWidget {
  static const String routeName = '/profile-search-entretien';
  const ProfileSearchEntretienPage({super.key});
  ...
  Widget build(BuildContext context) {
    return const MyScaffold(
      ...
      body: _EntretienSelectBody(),
    );
  }
}

class _EntretienSelectBody extends StatefulWidget {
  const _EntretienSelectBody();

  @override
  State<_EntretienSelectBody> createState() =>
      _EntretienSelectBodyState();
}

class _EntretienSelectBodyState
    extends State<_EntretienSelectBody> {
