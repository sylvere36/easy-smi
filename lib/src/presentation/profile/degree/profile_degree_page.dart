...
@RoutePage()
class ProfileDegreePage extends StatelessWidget {
  static const String routeName = '/profile-degree';
  const ProfileDegreePage({super.key});
...
class _AddDegreeBody extends StatefulWidget {
  const _AddDegreeBody();

  @override
  State<_AddDegreeBody> createState() => _AddDegreeBodyState();
}

class _AddDegreeBodyState extends State<_AddDegreeBody> {
  // UI palette
  ...
  // edit controller
  final TextEditingController _nbUniqueAuth = TextEditingController();
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _label('Catalogue'),
                  _DropdownField(
                    label: _degree ?? 'Selectionnez le diplôme',
                    hintColor: _degree == null ? kHint : kLabel,
                    radius: kRadius,
                    fill: kFieldFill,
                    stroke: kStroke,
                    onTap: () {
                      setState(() {
                        _degree = _degrees[Random.secure().nextInt(4)];
                      });
                      context.router.push(const ProfileSearchDegreeRoute());
                    },
                  ),
                  ...
                  // -------- Résultat -----------
                  _label('Numéro unique d\'authenticité', top: 22),
                  TextFormField(
                    controller: _nbUniqueAuth,
