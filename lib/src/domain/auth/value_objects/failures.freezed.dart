...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( InvalidEmail<T> value)?  invalidEmail,TResult Function( ShortPassword<T> value)?  shortPassword,TResult Function( PasswordWithoutSpecialChar<T> value)?  passwordWithoutSpecialChar,TResult Function( PasswordWithoutNumber<T> value)?  passwordWithoutNumber,required TResult orElse(),}){
final _that = this;
switch (_that) {
case InvalidEmail() when invalidEmail != null:
return invalidEmail(_that);case ShortPassword() when shortPassword != null:
return shortPassword(_that);case PasswordWithoutSpecialChar() when passwordWithoutSpecialChar != null:
return passwordWithoutSpecialChar(_that);case PasswordWithoutNumber() when passwordWithoutNumber != null:
return passwordWithoutNumber(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( InvalidEmail<T> value)  invalidEmail,required TResult Function( ShortPassword<T> value)  shortPassword,required TResult Function( PasswordWithoutSpecialChar<T> value)  passwordWithoutSpecialChar,required TResult Function( PasswordWithoutNumber<T> value)  passwordWithoutNumber,}){
final _that = this;
switch (_that) {
case InvalidEmail():
return invalidEmail(_that);case ShortPassword():
return shortPassword(_that);case PasswordWithoutSpecialChar():
return passwordWithoutSpecialChar(_that);case PasswordWithoutNumber():
return passwordWithoutNumber(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T failedValue)?  invalidEmail,TResult Function( T failedValue)?  shortPassword,TResult Function( T failedValue)?  passwordWithoutSpecialChar,TResult Function( T failedValue)?  passwordWithoutNumber,required TResult orElse(),}) {final _that = this;
switch (_that) {
case InvalidEmail() when invalidEmail != null:
return invalidEmail(_that.failedValue);case ShortPassword() when shortPassword != null:
return shortPassword(_that.failedValue);case PasswordWithoutSpecialChar() when passwordWithoutSpecialChar != null:
return passwordWithoutSpecialChar(_that.failedValue);case PasswordWithoutNumber() when passwordWithoutNumber != null:
return passwordWithoutNumber(_that.failedValue);case _:
  return orElse();
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T failedValue)?  invalidEmail,TResult? Function( T failedValue)?  shortPassword,TResult? Function( T failedValue)?  passwordWithoutSpecialChar,TResult? Function( T failedValue)?  passwordWithoutNumber,}) {final _that = this;
switch (_that) {
case InvalidEmail() when invalidEmail != null:
return invalidEmail(_that.failedValue);case ShortPassword() when shortPassword != null:
return shortPassword(_that.failedValue);case PasswordWithoutSpecialChar() when passwordWithoutSpecialChar != null:
